...
INSERT INTO location (location_Restaruant_name, location_Address, location_Postcode, location_City, location_Province, location_RHA)
...
WHERE initcap(textbox10) = location_restaruant_name AND textbox17 = location_address AND right(textbox20, 7) = location_Postcode;
...
FROM importData, location WHERE textbox16 NOT IN ('') AND initcap(textbox10) = location_restaruant_name AND textbox17 = location_address AND right(textbox20, 7) = location_Postcode;;