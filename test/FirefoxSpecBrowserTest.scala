...
class FirefoxSpecBrowserTest extends Specification {
  ...
  "select location page typeahead" should {
    ...
    "clear text field with clear typeahead button is pressed" in new WithBrowser(new FirefoxDriver) {
     ...
     "Searching" should {
    "display search page" in new WithBrowser(new FirefoxDriver){
     ...
     */
    "display the proper results for a !lax search" in new WithBrowser(new FirefoxDriver){
    ...
    "display the proper results when searching by address" in new WithBrowser(new FirefoxDriver){
      //search for 'Golden' in Luseland
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
    ...
    "displayed links should go to the right pages" in new WithBrowser(new FirefoxDriver){
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
      typeahead.sendKeys("Golden Dragon")
    ...
    "display no results" in new WithBrowser(new FirefoxDriver){
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
     ...
     */
    "display results searching with aliases" in new WithBrowser(new FirefoxDriver){
       //search for 'Golden' in Luseland
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
