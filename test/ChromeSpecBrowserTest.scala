...
class ChromeSpecBrowserTest extends Specification {
  ...
  "select city typeahead" should {
    ...
    "display choose location page when location is partially typed, hint is clicked" in new WithBrowser(new ChromeDriver) {
      browser.goTo("/")
      val typeahead = browser.getDriver.findElement(By.id("municipality"))
      typeahead.click
    ...
    "display choose location page when location is partially typed, down then tab is pressed" in new WithBrowser(new ChromeDriver) {
      browser.goTo("/")
      val typeahead = browser.getDriver.findElement(By.id("municipality"))
      typeahead.click
      typeahead.sendKeys("Saskato")
    ...
    "display choose location page when location is partially typed, down then right arrow is pressed" in new WithBrowser(new ChromeDriver) {
      browser.goTo("/")
      val typeahead = browser.getDriver.findElement(By.id("municipality"))
      typeahead.click
      typeahead.sendKeys("Saskato")
    ...
    "display choose location page when location is partially typed and down then enter arrow is pressed" in new WithBrowser(new ChromeDriver) {
      browser.goTo("/")
      val typeahead = browser.getDriver.findElement(By.id("municipality"))
      typeahead.click
      typeahead.sendKeys("Saskato")
  ...
  "select location page typeahead" should {
   ...
   "Searching" should {
    "display search page" in new WithBrowser(new ChromeDriver){
     ...
     */
    "display the proper results for a !lax search" in new WithBrowser(new ChromeDriver){
    ...
    "display the proper results when searching by address" in new WithBrowser(new ChromeDriver){
      //search for 'Golden' in Luseland
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
    ...
    "displayed links should go to the right pages" in new WithBrowser(new ChromeDriver){
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
      typeahead.sendKeys("Golden Dragon")
    ...
    "display no results" in new WithBrowser(new ChromeDriver){
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
     ...
     */
    "display results searching with aliases" in new WithBrowser(new ChromeDriver){
       //search for 'Golden' in Luseland
      browser.goTo("/find/luseland")
      val typeahead = browser.getDriver.findElement(By.id("location"))
      typeahead.click
